    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200 sm:px-20">
                <h2 class="mb-6 text-2xl font-semibold text-gray-800">Create Organization</h2>
                <form wire:submit.prevent="save" class="space-y-6">
                    ...
                    <div class="flex items-center justify-end mt-6">
                        ...
                        <button type="submit" class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition border border-transparent rounded-md bg-primary hover:bg-primary-dark active:bg-indigo-800 focus:outline-none focus:border-indigo-900 focus:ring focus:ring-indigo-300 disabled:opacity-25">
                            Create Organization
                        </button>
                    </div>
                </form>
